...
const PasswordInput = ({ labelName, inputValue, placeholder, inputOnChange,inputOnBlur,inputError, inputName }) => {
    ...
    return (
        <div className="grid">
           ...
           <input type={passwordVisibility?'text':'password'} name={inputName} onBlur={inputOnBlur} onChange={inputOnChange} value={inputValue} className="p-3 bg-[#f8f8f8] border text-sm rounded w-full text-primary"  placeholder={placeholder} />
